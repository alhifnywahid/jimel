/**
 * Registry preferensi - versi Vite/browser (tanpa Next server-cookie).
 * Semua persistence pakai client-cookie (document.cookie), dibaca ulang saat
 * boot oleh script di index.html. Struktur & atribut data-* dipertahankan
 * identik dengan dashboard sumber supaya semua komponen UI-nya jalan apa adanya.
 */
